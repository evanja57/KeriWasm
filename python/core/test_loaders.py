...
def load_kem_tests() -> List[TestEntry]:
    ...
    try:
        from tests.liboqs import test_kem
        ...
        tests.append(
            ("kem.test_python_attributes", test_kem.test_python_attributes, ())
        )
...
def load_sig_tests() -> List[TestEntry]:
    ...
    try:
        from tests.liboqs import test_sig
        ...
        tests.append(
            (
                "sig.test_sig_with_ctx_support_detection",
                test_sig.test_sig_with_ctx_support_detection,
                (),
            )
        )
        ...
        tests.append(
            ("sig.test_python_attributes", test_sig.test_python_attributes, ())
        )
...
def load_stfl_sig_tests() -> List[TestEntry]:
    ...
    try:
        from tests.liboqs import test_stfl_sig
        ...
        tests.append(
            ("stfl.test_python_attributes", test_stfl_sig.test_python_attributes, ())
        )
...
def load_blake3_tests() -> List[TestEntry]:
    ...
    try:
        from tests.blake3 import test_blake3
