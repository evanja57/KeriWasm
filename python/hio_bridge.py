...
async def test_hio_crypto_roundtrip(message="Hello KERI!"):
    ...
    class CryptoDoer(Doer):
        ...
        def recur(self, tyme):
            ...
            # Start verify request
                ...
                print(f"[CryptoDoer] Verifying...")
                self.pending_id = self._send_request('verify', {
    ...
    print(f"[test_hio_crypto_roundtrip] Complete!")
